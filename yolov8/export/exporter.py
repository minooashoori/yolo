...
if __name__ == "__main__":
    ...
    detect.load("/home/ec2-user/dev/yolo/runs/detect/train/weights/epoch4.pt")
    detect.export(format="torchscript", half=True, dynamic=False, batch=32, device="cpu", simplify=True)
