...
from PrecisionsRecallEvaluator import FixedConfidenceEvaluator
from utils import *
...
evaluator = FixedConfidenceEvaluator()
# Get precision and recall for a fixed confidence
resp = evaluator.getPrecisionRecall(
    0.9,  # Confidence
