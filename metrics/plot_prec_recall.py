...
if __name__ == "__main__":
    ...
    args.add_argument("--prod", type=str, default="/home/ec2-user/dev/ctx-logoface-detector/metrics/save/prod_logo.yaml")
    args.add_argument("--dev", type=str, default="/home/ec2-user/dev/ctx-logoface-detector/metrics/save/yolov8s_logo.yaml")
